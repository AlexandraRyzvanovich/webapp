...
public class OrderDto implements Identifiable {
    public static final String TABLE_NAME = "order_dto";
    public static final String ORDER_ID_COLUMN_NAME = "id";
    public static final String SUBSCRIPTION_NAME_COLUMN = "name";
